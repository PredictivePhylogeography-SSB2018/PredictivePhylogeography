...
Specifically, the study focused on the disjunct temperate rainforests of the Pacific Northwest of North America. This ecosystem is formed by tw disjunct extents of temperate rainforests, one in the Coastal and Cascades Mountain ranges, and the other inland Northern Rocky Mountains; the two zones are isolated by the Columbia Basin desert steppes. In this ecosystem, it has been shown that many taxa harbor cryptic diversity, and that, when present, this diversity is structured across the disjunction between the coastal and inland parts of the rainforest (*i.e.*, the Columbia Basin). Based on that knowledge, in this work we explored whether or not Random Forest analyses (Breiman, 2001), in combination with climatic and taxonomic information, could assist us in first classifying taxa that harbor or lack cryptic diversity, and then using the classifier to predict whether or not unstudied taxa harbor cryptic diversity. To do this, we collected georeferenced localities for each taxon that had been studied and had been shown to harbor or lack cryptic diversity. Then, we associated to each taxon its higher taxonomic rank (e.g., Mollusks for snails and slugs; Amphibian for salamanders and frogs; etc.), and for each of the localities, we extracted bioclimatic variables from the worldclim dataset.
